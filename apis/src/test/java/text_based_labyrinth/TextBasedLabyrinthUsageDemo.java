...
public class TextBasedLabyrinthUsageDemo {
    ...
    public static void main(String[] args) throws RoomFailedException {
        ...
        // Now we should only be able to move back towards the east, but lets try the other directions regardless
        ...
        // Lets go Up
        gameService.moveNorth();
        // now we should be able to go right according to the algorithm, but lets test everything else as well
        gameService.moveNorth();
        gameService.moveWest();
        gameService.moveEast();
