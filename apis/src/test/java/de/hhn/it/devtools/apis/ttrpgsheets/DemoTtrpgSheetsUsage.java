...
public class DemoTtrpgSheetsUsage {
  ...
  public static void main(String[] args) {
    ...
    logger.debug("" + characterSheet.getDescriptionDescriptor(DescriptionType.WEIGHT));
    ...
    logger.debug("" + characterSheet.getDiceDescriptor());
    ...
    logger.debug("" + characterSheet.getStatDescriptor(StatType.STRENGTH));
    ...
    logger.debug("" + characterSheet.getStatDescriptor(StatType.DEFENCE));
    logger.debug("" + characterSheet.getStatDescriptor(StatType.DEXTERITY));
    ...
    logger.debug("" + characterSheet.getStatDescriptor(StatType.HEALTH));
    ...
    logger.debug("" + characterSheet.getStatDescriptor(StatType.LEVEL));
    ...
    logger.debug("" + characterSheet.getStatDescriptor(StatType.AGILITY));
