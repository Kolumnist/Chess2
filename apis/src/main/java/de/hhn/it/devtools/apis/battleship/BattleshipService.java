...
public interface BattleshipService {
   ...
   */
  boolean isPlacementPossible(Player player, Ship shipToPlace, int x1, int y1, boolean isVertical)
   ...
   * @throws IllegalGameStateException if the GameState is not at PLACINGSHIPS
   */
  void unPlace(Player player, Ship shipToMove)
   ...
   * @throws IllegalShipStateException ship can't be rotated if it's placed
   * @throws IllegalGameStateException if the GameState is not at PLACINGSHIPS
   */
   ...
   */
  boolean bombPanel(Player attacker, Player victim, int x, int y)
      throws IllegalArgumentException, IllegalGameStateException;
   ...
   * @throws IllegalArgumentException if sound volume is negative or over 100
   */
