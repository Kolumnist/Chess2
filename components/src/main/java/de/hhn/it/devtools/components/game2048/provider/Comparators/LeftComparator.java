 ...
 * The smallest XPosition is going to be at index 0.
 */
public class LeftComparator implements Comparator<Block> {
  private static final org.slf4j.Logger logger =
          org.slf4j.LoggerFactory.getLogger(LeftComparator.class);
