 ...
 * The greatest YPosition is going to be at index 0.
 */
public class UpComparator implements Comparator<Block> {
  private static final org.slf4j.Logger logger =
          org.slf4j.LoggerFactory.getLogger(UpComparator.class);
