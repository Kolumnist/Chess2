...
public class WinningPopup extends VBox implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        difficultyLabel.setText(difficultyLabel.getText() + " " + getTextFromDifficulty((Difficulty) MemoryAttributeStore.getReference().getAttribute(MemoryServiceController.DIFFICULTY)));
