...
public class Game2048FileIO {
    ...
    public static int loadHighscore() {
        ...
        try {
            fileInputStream = new FileInputStream("javafx\\src\\main\\java\\de\\hhn\\it\\devtools\\javafx\\game2048\\provider\\SaveGame2048.txt");
    ...
    public static void saveHighscore(int highScore) {
        ...
        try {
            fileOutputStream = new FileOutputStream("javafx\\src\\main\\java\\de\\hhn\\it\\devtools\\javafx\\game2048\\provider\\SaveGame2048.txt");
        } catch (FileNotFoundException e) {
            e.printStackTrace();
        }
